          ...
          <div>
            <a href="#" className="inline-flex items-center gap-2.5">
              ...
              <span className="text-[20px] font-bold tracking-[-0.3px]">
                Whatsapp{" "}
                <span className="text-[#00c875]">CRM</span>
              </span>
            </a>
            ...
            <div className="mt-6 space-y-3">
              <div className="flex items-center gap-3 text-[14px] text-gray-400">
                <Mail size={17} className="text-[#00c875]" />
                <span>hello@whatsappcrm.com</span>
              </div>

              <div className="flex items-center gap-3 text-[14px] text-gray-400">
                <Phone size={17} className="text-[#00c875]" />
          ...
          <div>
            ...
            <ul className="space-y-3.5">
              <li>
                <a
                  href="#features"
                  className="text-[14px] text-gray-400 transition-colors hover:text-[#00c875]"
                >
                  Features
                </a>
              </li>
